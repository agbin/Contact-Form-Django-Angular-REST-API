...
var ApiService = /** @class */ (function () {
    ...
    ApiService.prototype.getOneContact = function (id) {
    ...
    ApiService.prototype.updateContact = function (contact) {
        var body = { name: contact.name, email: contact.email, subject: contact.subject, message: contact.message };
...
var AppComponent = /** @class */ (function () {
    ...
    function AppComponent(api) {
        ...
        this.getContacts = function () {
            _this.api.getAllContacts().subscribe(function (data) {
                _this.contacts = data;
            }, function (error) {
                console.log(error);
            });
        ...
        this.contactClicked = function (contact) {
            _this.api.getOneContact(contact.id).subscribe(function (data) {
        ...
        this.updateContact = function () {
            _this.api.updateContact(_this.selectedContact).subscribe(function (data) {
                _this.getContacts();
        ...
        this.createContact = function () {
            _this.api.createContact(_this.selectedContact).subscribe(function (data) {
        ...
        this.deleteContact = function () {
            _this.api.deleteContact(_this.selectedContact.id).subscribe(function (data) {
                _this.getContacts();
            }, function (error) {
                console.log(error);
            });
